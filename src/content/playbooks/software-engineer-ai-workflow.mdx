...
<SponsoredAdSlot 
  title="The AI Code Editor You Need" 
  description="Cursor is a fork of VS Code with AI built directly into the editor. It can see your entire codebase and refactor multiple files simultaneously." 
