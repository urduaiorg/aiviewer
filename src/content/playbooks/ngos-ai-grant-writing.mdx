...
<AnswerBox 
  question="How can NGOs use AI for grant writing?"
  answer="NGOs can use AI answer engines like Perplexity to research matching grants, use Claude Opus 4.6 to structure and draft compelling narratives based on past successful proposals, and use GPT-5.4 to strictly format the final application to meet the funder's exact rubric."
/>
