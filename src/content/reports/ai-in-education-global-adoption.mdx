...
Yes. During the most recent school year, a joint RAND survey found that nearly 60% of principals and over 25% of teachers report using AI for school workflows. Educators are using tools like [ChatGPT](/tools/chatgpt/) to draft lesson plans, generate writing prompts, and handle administrative communications.
