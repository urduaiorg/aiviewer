...
### 3. AI Dubbing
A massive feature for global creators. You can upload a video in English, and ElevenLabs will translate the audio into Spanish, French, or Japanese---while keeping the *exact same voice* of the original speaker, and attempting to match the lip movements. Pair this with [Runway Gen-3 Alpha](/tools/runway-gen3/) for AI-generated visuals and you have a complete end-to-end video production pipeline.
