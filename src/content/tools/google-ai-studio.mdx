---
title: "Google AI Studio: Workspace and Access Guide"
seoTitle: "Google AI Studio: Workspace and Access Guide"
...
## Estimate an API workload separately

Use the [worked Gemini API cost exercise](/guides/google-ai-studio-free-in-2026-what-is-actually-free-and-what-costs-money/) to calculate input and output usage, allow for retries and identify extra charges. This profile introduces the workspace; the companion lesson shows the calculation.
...
## Use the workspace for a bounded experiment

Check the current model, account and data terms before starting your experiment. The boundary is clear: free workspace access does not erase API limits, cloud costs, security responsibilities, or data-use terms. Use AI Studio to prove the workflow; enable paid infrastructure only when the prototype has earned it.
