...
This is a **research-based evaluation**, checked against Google's Gemini API billing and pricing documentation on July 11, 2026. Model names, limits, and availability can change, so the linked Google pages remain the final source of truth.
