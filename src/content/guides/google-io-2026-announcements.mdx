...
Gemini 3.5 Flash is already available through the Gemini app and the [Gemini API via Google AI Studio](/guides/how-to-use-google-ai-studio).
...
If you have been following [AI video generation tools](/guides/best-ai-video-generators), Omni is Google's most serious entry into this space yet — and the YouTube integration opens it to the world's largest creator platform.
