...
<ProsCons
  ...
  pros={["Composer model delivers ultra-fast, purpose-built code generation", "Multi-agent interface lets you run parallel agents across your codebase", "Choose your LLM: Claude Sonnet 4.6 (1M tokens), Claude Opus 4.6, GPT-5.2, Gemini 3 Pro, Grok Code", "Now available in JetBrains IDEs via Agent Client Protocol (ACP)", "Familiar VS Code interface with deep codebase indexing"]}
