...
The most common mistake is treating "free to try" as "free to operate." AI Studio is a good place to learn the behavior of a workflow. Production requires a cost model, rate-limit plan, and review process.
